...
# Inicializar
pygame.init()
pygame.mixer.music.load("DAISY.ogg")
...
# Carga imágenes
fondo = pygame.image.load("castillo.png").convert()
nave_arr = pygame.image.load("AR.png").convert_alpha()
nave_abj = pygame.image.load("A.png").convert_alpha()
nave_izq = pygame.image.load("I.png").convert_alpha()
nave_der = pygame.image.load("D.png").convert_alpha()

aste_1a = pygame.image.load("CV.png").convert_alpha()
aste_1b = pygame.image.load("BO.png").convert_alpha()
aste_1c = pygame.image.load("CAR.png").convert_alpha()
aste_1d = pygame.image.load("caA.png").convert_alpha()
...
aste_2a = pygame.image.load("CV.png").convert_alpha()
aste_2b = pygame.image.load("BO.png").convert_alpha()
aste_2c = pygame.image.load("CAR.png").convert_alpha()
aste_2d = pygame.image.load("caA.png").convert_alpha()
...
while en_juego:
    ...
    while en_inicio:
        ...
        historia = [
            ...
            "               Es un periodo de guerra en el reino champiñon.",
            "               La princesa peach fue secuestrada y , bowser esta atacanndo.",
            "               Ayuda a daisy a salvar a su mejor amiga.",
            "",
    ...
    while en_partida:
        ...
        while en_final:
            ...
            historia_perdido = [
                "    Te han derrotado las fuerzas de bowser Sin embargo has tenido",
                "   suerte y tus amigos han llegado a rescatarte. ",
                "  ¿Quieres comer un champiñon e intentarlo de nuevo?",
                "",
                "              Pulsa 's' para volverlo a intentar",
                "              Pulsa 'n' para salir del juego"]

            historia_ganado = [
                "  Excelente, acabas de destruir a los malos.",
                "  Los champiamigos estarán muy contentos con este gran triunfo.",
                "       Te has convertido en una princesa legitima del reino champiñon.",
